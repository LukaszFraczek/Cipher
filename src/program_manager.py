...
class Manager:
    def __init__(self):
        ...
        self.menu = MenuHandler(self, self.buffer)
    ...
    def encode_message(self, msg_idx, new_rot) -> bool:
    ...
    def delete_message(self, msg_idx) -> None:
